...
// Centralized service-specific configuration
const serviceContent = {
  ...
  water: {
    heading: "Make waves with our\nwater recreation services!",
    useCases: [
      { number: "01", title: "Jet Ski Adventures" },
      { number: "02", title: "Boat Rentals" },
      { number: "03", title: "Yacht Cruises" },
      { number: "04", title: "Boat Parties" },
    ],
    ctaCard: {
      title: "Dive in now",
      description:
      ...
      <div className="relative rounded-3xl overflow-hidden h-[300px] sm:h-[400px] md:h-[450px] mb-8 sm:mb-12">
        ...
        <div className="relative z-10 h-full flex items-center p-6 sm:p-8 md:p-12">
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(90deg, #E05D3D 0%, #FFC0B1 100%)",
            }}
          >
            <div>
