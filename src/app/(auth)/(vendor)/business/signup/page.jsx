...
export default function VendorSignUpScreen() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Start listing services and managing bookings."
    >
      {/* Form */}
      <div className="space-y-5">
        ...
        <div>
          <div className="relative">
            <input
              ...
              className={`w-full px-5 py-4 pr-12 border-2 rounded-xl focus:outline-none focus:ring-0 transition-colors text-gray-900 placeholder-gray-400 ${
                confirmError ? "border-red-500" : "border-gray-300 focus:border-gray-900"
              }`}
            />
            <button
              type="button"
        ...
        <p className="text-xs text-gray-500 text-center">
          ...
          <Link href="/terms" className="text-gray-900 hover:underline">Terms</Link> and{" "}
        ...
        <p className="text-sm text-gray-600 text-center pt-4">
          ...
          <Link href="/business/login" className="text-gray-900 hover:underline font-medium">Sign in</Link>
        </p>
      </div>
    </AuthLayout>
  );
