...
export default function VendorForgotPasswordScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push(`/business/reset-password?email=${encodeURIComponent(email.trim())}`);
      }, 1500);
    } catch (err) {
        ...
        <div className="space-y-6 animate-in fade-in duration-500">
          ...
          <div className="space-y-4">
            ...
            <div className="text-center">
              ...
              <button
                onClick={() => router.push(`/business/reset-password?email=${encodeURIComponent(email.trim())}`)}
      ...
      <div className="space-y-6 animate-in fade-in duration-500">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-600">
              Enter the email address associated with your business account. We'll send you a secure link to create a new password.
            </p>
          </div>
        </div>
        ...
        <div className="text-center space-y-3 pt-2">
          <p className="text-sm text-gray-600">
            ...
            <Link 
              href="/business/login" 
              className="text-gray-900 hover:text-gray-700 font-semibold hover:underline transition-colors"
            >
              Sign in instead
            </Link>
          </p>
