...
export default function NewCarRentalListing() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Car rental listing:", form, images);
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Add Car Rental Listing</h1>
        <p className="text-gray-600 mt-1">Create a new vehicle listing with chauffeur service</p>
      </div>
