...
export default function PopularDestinationsCard({
  ...
  return (
    <div className="absolute left-0 top-[52px] w-md bg-white border border-gray-200 rounded-md shadow-lg z-10 p-4">
      ...
      <ul className="space-y-1">
        {destinations.map((dest, idx) => (
          ...
          >
            ...
            {dest.city}
            <span className="ml-2 text-gray-400">{dest.airport}</span>
          </li>
        ))}
      </ul>
    </div>
