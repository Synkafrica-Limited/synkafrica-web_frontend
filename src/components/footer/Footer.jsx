      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8">
          ...
          <nav className="hidden lg:flex space-x-8 mb-6 lg:mb-0">
            ...
            <Link href="/partner" className="text-gray-600 hover:text-gray-900 transition-colors">
              Partner With Us
            </Link>
          ...
          <div className="flex space-x-3">
            ...
            <a href="#" className="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center hover:opacity-90 transition-opacity">
              <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/services/convenience" className="text-gray-600 hover:text-gray-900 transition-colors">
                  Convenience Services
                </Link>
              </li>
              <li>
                <Link href="/services/dining" className="text-gray-600 hover:text-gray-900 transition-colors">
                  Dining & Restaurant Reservations
                </Link>
              </li>
              <li>
                <Link href="/services/car-rentals" className="text-gray-600 hover:text-gray-900 transition-colors">
                  Car Rentals
                </Link>
              </li>
              <li>
                <Link href="/services/flights" className="text-gray-600 hover:text-gray-900 transition-colors">
                  Flights Bookings
                </Link>
              </li>
              <li>
                <Link href="/services/vendor-listings" className="text-gray-600 hover:text-gray-900 transition-colors">
                  Vendor listings
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/vendor/list-cars" className="text-gray-600 hover:text-gray-900 transition-colors">
                  List your cars
                </Link>
              </li>
              <li>
                <Link href="/vendor/showcase" className="text-gray-600 hover:text-gray-900 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-600">
              ...
              <p className="mt-4">
                <a href="tel:+2340812323392" className="hover:text-gray-900 transition-colors">
                  +234 0812 323 392
                </a>
              </p>
              <p>
                <a href="tel:+2340812123392" className="hover:text-gray-900 transition-colors">
                  +234 0812 123 392
                </a>
              </p>
              <p className="mt-4">
                <a href="mailto:info@synkafrica.com" className="hover:text-gray-900 transition-colors">
                  info@synkafrica.com
                </a>
              </p>
            </div>
